...
class CrocReposition {
    ...
    rebal() {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            return (yield this.pool.context).dex.userCmd(path, directive.encodeBytes());
        });
    }
    simStatic() {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
    ...
    swapOutput() {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            let swap = new swap_1.CrocSwapPlan(sellToken, buyToken, yield this.convertCollateral(), false, this.impact, (yield this.pool).context);
