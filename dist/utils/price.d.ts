...
export declare function encodeCrocPrice(price: number): BigNumber;
export declare function decodeCrocPrice(val: BigNumber): number;
export declare function toDisplayPrice(price: number, baseDecimals: number, quoteDecimals: number, isInverted?: boolean): number;
