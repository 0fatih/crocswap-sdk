...
function liquidityForBaseQty(price, qty, mult = 1.0) {
    return (0, _1.floatToBigNum)(Math.floor(((0, _1.bigNumToFloat)(qty) / Math.sqrt(price)) * mult));
}
...
function baseVirtualReserves(price, liq, mult = 1.0) {
    return (0, _1.floatToBigNum)((0, _1.bigNumToFloat)(liq) * Math.sqrt(price) * mult);
}
